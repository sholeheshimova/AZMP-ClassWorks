...
// function tapHamsin(num1 ,num2, op) {
...
// }
// console.log(arr([3,54,6,8]));

// 6) arrayın bütün elementlərinin cəmini qaytaran funksiya yazın

// let sum = 0;
// function arr(array) {
//     return sum = array[0]+array[1]+array[2]+array[3]+array[4]
// }
...
// console.log(maxElement([2,3,4,5,6]));
...
// function bolunenEded (number){
//     if (number % 2 === 0) {
//         console.log("eded 2ye bolunur");
...
// let array = [2,3,4,5,6];
// let umumiCem = sumArray(array)
// console.log(umumiCem);
...
// function telebeQiymetleri(qiymet){
//     for (let i = 0; i < qiymet.length; i++) {
//         if (qiymet[i] >= 60) {
//             console.log("kecdi");
...
// let array = [23,5,26,75,32,12,4,5];
// console.log(maxDeyer(array));
